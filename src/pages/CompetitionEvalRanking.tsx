...
const CompetitionEvalRanking = (): ReactElement => {
          ...
          {loading ? (
            ...
            <>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '10px' }}>
                ...
                <Link to="/competition/eval-summary" className="btn btn-secondary" style={{ padding: '7px 16px', fontSize: '13.5px' }}>
                  상세 집계표 보기 →
                </Link>
              </div>
              ...
              {rows.length === 0 ? (
                ...
                <RankingTable
                  ...
                  maxTotal={MAX_TOTAL}
                  onRowClick={() => navigate('/competition/eval-summary')}
                />
              )}
