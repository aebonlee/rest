...
import { groupByRoster } from '../../utils/people'; // 공식 명단 기준으로 사람을 묶어주는 함수
import { ACTIVE_ROSTER } from '../../config/roster'; // 성적 집계 source of truth — 활성 수강생 명단
        ...
        <div className="admin-content">
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-end', flexWrap: 'wrap', gap: '12px', marginBottom: '16px' }}>
            ...
            <div style={{ fontSize: '14.5px', fontWeight: 600, color: 'var(--primary-blue, #0046C8)' }}>
              수강생 {people.length}명 {/* 공식 명단 기준 활성 수강생 수 */}
              {/* 계정 매칭 안 된(미가입 의심) 인원만 부가 경고 표기 */}
