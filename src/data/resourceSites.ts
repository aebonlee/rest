...
export const SITE_GROUPS: SiteGroup[] = [
  { id: 'ai', label: 'AI 활용', icon: '🤖', owner: 'mine', sites: [
    ...
    { name: 'OpenClaw 학습', desc: 'OpenClaw AI 플랫폼 활용 가이드', url: 'https://openclaw.dreamitbiz.com' },
    ...
    { name: '하네스 마스터', desc: 'Harness 에이전트 오케스트레이션 — 팀 설계부터 실전', url: 'https://harness-study.dreamitbiz.com' },
  ...
  { id: 'coding', label: '코딩·웹 개발', icon: '💻', owner: 'mine', sites: [
    { name: 'HTML/CSS 학습', desc: '웹 프론트엔드 기초, HTML5, CSS3, 반응형 웹', url: 'https://html.dreamitbiz.com' },
    { name: '웹 개발 학습', desc: '웹 개발 종합 (HTML, CSS, JS, 프레임워크)', url: 'https://webstudy.dreamitbiz.com' },
