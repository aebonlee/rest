...
- 정답이 없는 열린 질문
- 자기 발견을 돕는 질문
- 예시: "오늘 가장 편안했던 순간은?", "나에게 '괜찮아'라고 말해준다면?"`,note:"강제하지 않고, 답하지 않아도 되는 분위기로"}]},implementation:{frontend:{description:"감정 체크인 UI, 루틴 카드, 격려 화면, 성찰 저널, 회복 그래프",pages:["감정 체크인 (이모지 + 점수)","오늘의 루틴 (카드형 추천)","격려 & 성찰 (저널링)","회복 그래프 (주간/월간)","루틴 히스토리","설정 (알림 시간)"],stack:"React 19 + TypeScript + Chart.js + Tailwind + 이모지"},backend:{description:"감정 기록, 루틴 추천/수행 관리, 격려 생성",apis:["POST /checkin — 감정 체크인","POST /routine — 루틴 추천","POST /complete — 루틴 완료 체크","POST /encourage — 격려 메시지","POST /reflect — 성찰 질문","GET /stats — 회복 통계"],stack:"Supabase Edge Functions + Solar API"},database:{tables:[{name:"solar_emotions",fields:"id, user_id, score(1-10), keywords(text[]), note, created_at"},{name:"solar_routines",fields:"id, user_id, date, recommended(jsonb), completed(jsonb), created_at"},{name:"solar_journals",fields:"id, user_id, question, answer, created_at"}]}},deployment:{steps:["프론트엔드 빌드 & 배포","Edge Functions 배포","Solar API Key 등록","알림 시스템 설정 (Push/Email)","베타 테스트 (심리상담사 감수)"],infra:"GitHub Pages + Supabase + Solar API + Web Push"},expansion:["청년 회복 프로그램 공식 도구 채택","정서지원 AI 서비스 (범용)","CBT(인지행동치료) 기반 확장","사회복지사 모니터링 대시보드","마음건강 커뮤니티 연계"]}],n=({icon:s,title:t,children:a})=>e.jsxs("section",{className:"pgd-section",children:[e.jsxs("h2",{children:[e.jsx("span",{className:"pgd-section-icon",children:s})," ",t]}),e.jsx("div",{className:"pgd-card",children:a})]}),g=({project:s})=>e.jsxs(e.Fragment,{children:[e.jsxs(n,{icon:"ℹ️",title:"프로젝트 개요",children:[e.jsx("p",{className:"pgd-overview",children:s.overview}),e.jsxs("div",{className:"pgd-meta-grid",children:[e.jsxs("div",{children:[e.jsx("h4",{children:"주요 대상"}),e.jsx("ul",{children:s.targetUsers.map((t,a)=>e.jsx("li",{children:t},a))})]}),e.jsxs("div",{children:[e.jsx("h4",{children:"학습 목표"}),e.jsx("ul",{children:s.objectives.map((t,a)=>e.jsx("li",{children:t},a))})]})]})]}),e.jsxs(n,{icon:"🏗️",title:"시스템 아키텍처",children:[e.jsx("p",{children:s.architecture.description}),e.jsx("div",{className:"pgd-diagram",children:e.jsx("pre",{children:s.architecture.diagram})}),e.jsx("div",{className:"pgd-components",children:s.architecture.components.map((t,a)=>e.jsxs("div",{className:"pgd-component",children:[e.jsx("h4",{children:t.name}),e.jsx("p",{children:t.description}),e.jsx("span",{className:"pgd-tech-badge",children:t.tech})]},a))})]}),e.jsx(n,{icon:"🔄",title:"데이터 파이프라인",children:e.jsx("div",{className:"pgd-pipeline",children:s.pipeline.steps.map(t=>e.jsxs("div",{className:"pgd-pipeline-step",children:[e.jsx("div",{className:"pgd-step-num",style:{background:s.color},children:t.step}),e.jsxs("div",{className:"pgd-step-body",children:[e.jsx("h4",{children:t.title}),e.jsx("p",{children:t.description}),e.jsx("span",{className:"pgd-tech-badge",children:t.tools})]})]},t.step))})}),e.jsxs(n,{icon:"☀️",title:"Solar API 활용",children:[e.jsx("p",{children:s.solarApi.description}),s.solarApi.endpoints.map((t,a)=>e.jsxs("div",{className:"pgd-api-endpoint",children:[e.jsx("h4",{children:t.name}),e.jsx("p",{children:t.purpose}),e.jsx("div",{className:"pgd-code-block",children:e.jsx("code",{children:t.example})})]},a))]}),e.jsxs(n,{icon:"✨",title:"프롬프트 엔지니어링",children:[e.jsx("p",{children:s.prompts.description}),s.prompts.examples.map((t,a)=>e.jsxs("div",{className:"pgd-prompt",children:[e.jsx("h4",{children:t.title}),e.jsx("div",{className:"pgd-prompt-block",children:e.jsx("pre",{children:t.prompt})}),e.jsxs("p",{className:"pgd-prompt-note",children:["💡 ",t.note]})]},a))]}),e.jsxs(n,{icon:"💻",title:"구현 가이드",children:[e.jsxs("div",{className:"pgd-impl-grid",children:[e.jsxs("div",{className:"pgd-impl-item",children:[e.jsx("h3",{children:"🖥️ 프론트엔드"}),e.jsx("p",{children:s.implementation.frontend.description}),e.jsx("span",{className:"pgd-tech-badge",children:s.implementation.frontend.stack}),e.jsx("h4",{children:"주요 페이지"}),e.jsx("ul",{children:s.implementation.frontend.pages.map((t,a)=>e.jsx("li",{children:t},a))})]}),e.jsxs("div",{className:"pgd-impl-item",children:[e.jsx("h3",{children:"⚙️ 백엔드"}),e.jsx("p",{children:s.implementation.backend.description}),e.jsx("span",{className:"pgd-tech-badge",children:s.implementation.backend.stack}),e.jsx("h4",{children:"API 엔드포인트"}),e.jsx("ul",{children:s.implementation.backend.apis.map((t,a)=>e.jsx("li",{children:t},a))})]})]}),e.jsxs("div",{className:"pgd-db",children:[e.jsx("h3",{children:"🗄️ 데이터베이스"}),e.jsx("div",{className:"pgd-db-tables",children:s.implementation.database.tables.map((t,a)=>e.jsxs("div",{className:"pgd-db-table",children:[e.jsx("h4",{children:t.name}),e.jsx("code",{children:t.fields})]},a))})]})]}),e.jsxs(n,{icon:"🚀",title:"배포 계획",children:[e.jsx("span",{className:"pgd-tech-badge",children:s.deployment.infra}),e.jsx("ol",{className:"pgd-deploy-steps",children:s.deployment.steps.map((t,a)=>e.jsx("li",{children:t},a))})]}),e.jsx(n,{icon:"🌟",title:"확장 가능성",children:e.jsx("ul",{className:"pgd-expansion",children:s.expansion.map((t,a)=>e.jsxs("li",{children:[e.jsx("span",{style:{color:s.color},children:"✓"})," ",t]},a))})})]}),x=()=>{const{id:s}=m(),t=h(),[a,l]=c.useState(s?Number(s):1);c.useEffect(()=>{s&&l(Number(s))},[s]);const o=r.find(i=>i.id===a)||r[0],p=i=>{l(i),t(`/project-guide/${i}`,{replace:!0}),window.scrollTo({top:0,behavior:"smooth"})};return e.jsxs(e.Fragment,{children:[e.jsx(S,{title:o.title,path:`/project-guide/${a}`}),e.jsx("section",{className:"page-header",children:e.jsxs("div",{className:"container",children:[e.jsx("h2",{children:"프로젝트 안내"}),e.jsx("p",{children:"AI 리부트 경진대회를 위한 7가지 프로젝트 가이드입니다. Solar LLM을 활용한 실전 프로젝트를 확인하세요."})]})}),e.jsxs("div",{className:"sidebar-layout",children:[e.jsx("aside",{className:"sidebar",children:e.jsx("nav",{className:"sidebar-menu",children:r.map(i=>e.jsxs("button",{className:`sidebar-item ${i.id===a?"active":""}`,onClick:()=>p(i.id),children:[e.jsx("span",{className:"sidebar-item-icon",children:i.icon}),e.jsx("span",{className:"sidebar-item-text",children:i.title})]},i.id))})}),e.jsxs("div",{className:"sidebar-content",children:[e.jsxs("div",{className:"pgd-hero-card",style:{borderLeftColor:o.color},children:[e.jsx("span",{className:"pgd-hero-icon",style:{background:`${o.color}18`,color:o.color},children:o.icon}),e.jsxs("div",{children:[e.jsx("h3",{className:"pgd-hero-title",children:o.title}),e.jsx("p",{className:"pgd-hero-subtitle",children:o.subtitle}),e.jsx("div",{className:"pg-card-tags",style:{marginTop:"8px"},children:o.solarApi.endpoints.map((i,d)=>e.jsx("span",{className:"pg-tag",children:i.name.split(" (")[0]},d))})]})]}),e.jsx(g,{project:o})]})]})]})};export{x as default};
